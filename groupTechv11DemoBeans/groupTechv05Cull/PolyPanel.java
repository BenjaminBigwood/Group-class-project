...
public class PolyPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < triCount; i++) {
            if (!tris[i].culled()) {
                ...
                if(v==0) {
                    renderText("Start", 650, 100, g);
                    renderText("Options", 650, 200, g);
                    renderText("Quit", 650, 300, g);
                } else if(v==1) {
                    renderText("Start", 650, 100, g);
                    renderText("Volume", 650, 200, g);
                    renderText("Res", 650, 300, g);
                }
            }
        }
        g.drawOval(5, 5, 5, 5);
    ...
    public void clicked(int current) {
        start = false;
        this.v = current;
    }
