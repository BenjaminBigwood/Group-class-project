...
public class Tri{
    ...
    int color, co, si, co2, si2, tempx,tempx2,tempy,tempz,group,turns,tex,res;
    boolean culled,face;
    SceneInfo s = Main.s;
    public Tri() {
        int[] sc = s.screenRd();
    ...
    public void pos(int x1, int y1, int z1,int x2, int y2, int z2,int x3, int y3, int z3, int color, boolean face, int group, int turns, int tex, int res) {
        this.x[0] = x1;
        this.y[0] = y1;
        this.z[0] = z1;
        this.x[1] = x2;
